...
## 주요 기능
### [회원가입 및 로그인 기능] `조현아`
**<span style='color: #fff; background-color: #ff6600'>회원가입</span>**
...
**<span style='color: #fff; background-color: #ff6600'>로그인</span>**
  1. input 값을 받아와 입력 조건에 대입합니다.
...
----
#### [미니홈피 관리 기능] `조현아`   
> 로그인한 사용자와 미니홈피 관리자(주인) 데이터의 분리 처리
